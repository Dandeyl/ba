					...
					<section class="row-fluid">
						<div class="span8">
							<article>
								<header>
									<hgroup>
                                                                            <h1><i class="icon-bolt"></i> Dynamic Source Code Analysing</h1>
									</hgroup>
								</header>

								<p class="lead">Find more flaws. Get less false results.</p>
								
                                                                <p>Our dynamic source code scanning allows t</p>
								<footer>
							...
							<article>
								<header>
									<hgroup>
                                                                            <h1><i class="icon-eye-open"></i> Detects a lot of common security flaws</h1>
									</hgroup>
								</header>
                        ...
                        <p>QUnit is now installed, but not activated. To do that, open ki</p>
							</article>
                     ...
                     <p class="alert alert-success">Check out <a href="http://getkickstrap.com/docs/1.1/"><i class="icon-book"></i> The docs</a> to work in and extend Kickstrap.</p>
						...
						<aside class="span4 well bs-docs-sidebar"> 
							<ul class="nav nav-list bs-docs-sidenav affic">
								<li class="nav-header">Vulnerabilities that get detected</li>
								<li class="active"><a href="#dynamic-source-code-analysing">Cross Site Scripting</a></li>
								<li><a href="#detect">SQL-Injection</a></li>
							</ul>
						</aside>
					</section>
