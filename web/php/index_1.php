   ...
   <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand">Scanner</a>
          <div class="nav-collapse">
            <ul class="nav">
              <li><a href="./scan/">Scan Your Source Code</a></li>
					...
					<section class="row-fluid">
						<div class="span8">
							<article>
								<header>
									<hgroup>
                                                                            <a name="dynamic-source-code-analysing"></a><h1><i class="icon-bolt"></i> Dynamic Source Code Analysing</h1>
									</hgroup>
								</header>
							...
							<article>
								<header>
									<hgroup>
										<a name="detect"></a><h1 data-bind="text: welcomeMessage"><i class="icon-eye-open"></i> Detects a lot of common security flaws</h1>
									</hgroup>
								</header>
                        ...
                        <p>QUnit is now installed, but not activated. To do that, open kickstrap.less and add "qunit" to the comma-separated list of @apps. Save this file and refresh this page.<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p> You should see some Javascript tests run at the top of this page.</p>
								<footer>
									<p class="muted">Posted <a href="#">Today</a> by <a href="">Adam Kochanowicz</a></p>	
								</footer>
							</article>
                     ...
                     <p class="alert alert-success">Check out <a href="http://getkickstrap.com/docs/1.1/"><i class="icon-book"></i> The docs</a> to work in and extend Kickstrap.</p>
						...
						<aside class="span4 well bs-docs-sidebar"> 
							<ul class="nav nav-list bs-docs-sidenav affic">
								<li class="nav-header">Content on this page</li>
								<li class="active"><a href="#dynamic-source-code-analysing">Dynamic Source Code Analysing</a></li>
								<li><a href="#detect">Detects a lot of common security flaws</a></li>
							</ul>
						</aside>
					</section>
